    ...
    <main className="min-h-screen bg-indigo-900 flex flex-col items-center justify-center p-8">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full">
        ...
        <div className="space-y-4 text-gray-700">
          ...
          <p>We may collect personal information such as your name, email address, and usage data when you use our service.</p>
          
          <h2 className="text-xl font-semibold">2. How We Use Your Information</h2>
          <p>We use your information to provide and improve our service, communicate with you, and comply with legal obligations.</p>
          ...
          <p>We may use third-party services that collect, monitor and analyze user data to improve our service.</p>
